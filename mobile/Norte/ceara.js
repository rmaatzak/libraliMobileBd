// ./Norte/ceara.js  ← 💡 (ideal: renomeie o arquivo para ceara.js)
...
// ⭐ LETRAS do CEARÁ — n, p, q, r, s (ordem fixa!)
const steps = [
  { id: "n", label: "N", image: require("../assets/Norte/n.png") },
  { id: "p", label: "P", image: require("../assets/Norte/p.png") },
  { id: "q", label: "Q", image: require("../assets/Norte/q.png") },
  { id: "r", label: "R", image: require("../assets/Norte/r.png") },
  { id: "s", label: "S", image: require("../assets/Norte/s.png") },
];


const VIDEOS_LIBRAS = {
  n: require("../assets/Norte/n.mp4"),
  p: require("../assets/Norte/p.mp4"),
  q: require("../assets/Norte/q.mp4"),
  r: require("../assets/Norte/r.mp4"),
  s: require("../assets/Norte/s.mp4"),
};

export default function Ceara({ navigation }) { 
  ...
  // --- Tela inicial (CEARÁ) desaparece após 3s
  useEffect(() => {
    if (screen === "overlay") {
  ...
  const handleContinueVideo = () => {
    if (currentStep < 4) { // 5 etapas: 0 a 4
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      {/* Tela de introdução: CEARÁ */}
      {screen === "overlay" && (
        <Animated.View style={[styles.overlay, { opacity: overlayFade }]}>
          <Text style={styles.overlayText}>CEARÁ</Text> {/* ✅ Corrigido! */}
        </Animated.View>
      )}
      ...
      {screen === "como" && (
        <ImageBackground
          source={require("../assets/Norte/ceara.png")}
          style={styles.bg}
        >
          <View style={styles.frameBorder}>
            <View style={styles.center}>
              ...
              <Image
                source={require("../assets/Norte/rosa.png")}
          ...
          <View style={styles.frameBorder}>
            <View style={styles.center}>
              <View style={styles.videoBox}>
                <Video
                  ref={videoRef}
                  source={VIDEOS_LIBRAS[steps[currentStep].id]} // ✅ Usa steps[currentStep].id (ex: "n")
                  style={styles.video}
                  resizeMode="contain"
                  isMuted={true}
                  shouldPlay={true}
            ...
            <View style={styles.frameBorder}>
              <View style={styles.center}>
                ...
                <View style={styles.gameArea}>
                  {/* ✅ Coluna de imagens — ORDEM FIXA: N, P, Q, R, S */}
                    ...
                    {shuffledVideos.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <Video
                              source={VIDEOS_LIBRAS[item.id]} // ✅ Usa VIDEOS_LIBRAS[item.id] (ex: "q.mp4")
      ...
      {screen === "finalizado" && (
        <View style={styles.finalizadoContainer}>
          ...
          <View style={styles.center}>
            <Animated.Image
              source={require("../assets/Norte/Nordeste1.png")} 
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("NorteHome", { faseConcluida: 4 }) 
              }
            >
              <Image
                source={require("../assets/Norte/certo.png")}
