...
// ⭐ 5 VOGAIS — dados das etapas (ordem fixa!)
const steps = [
  { id: "a", label: "A", image: require("../assets/Norte/a.png") },
  { id: "e", label: "E", image: require("../assets/Norte/e.png") },
  { id: "i", label: "I", image: require("../assets/Norte/i.png") },
  { id: "o", label: "O", image: require("../assets/Norte/o.png") },
  { id: "u", label: "U", image: require("../assets/Norte/u.png") },
];

const VIDEOS_LIBRAS = {
  a: require("../assets/Norte/a.mp4"),
  e: require("../assets/Norte/e.mp4"),
  i: require("../assets/Norte/i.mp4"),
  o: require("../assets/Norte/o.mp4"),
  u: require("../assets/Norte/u.mp4"),
};
...
export default function Amazonia({ navigation }) {
  ...
  // --- Tela inicial (AMAZÔNIA) desaparece após 3s
  useEffect(() => {
    if (screen === "overlay") {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      {/* Tela de introdução: AMAZÔNIA */}
      {screen === "overlay" && (
        <Animated.View style={[styles.overlay, { opacity: overlayFade }]}>
          <Text style={styles.overlayText}>AMAZONAS</Text>
        </Animated.View>
      )}
      ...
      {screen === "como" && (
        <ImageBackground
          source={require("../assets/Norte/floresta.png")}
          style={styles.bg}
        >
          <View style={styles.frameBorder}>
            <View style={styles.center}>
              ...
              <Image
                source={require("../assets/Norte/roxo.png")}
            ...
            <View style={styles.frameBorder}>
              <View style={styles.center}>
                ...
                <View style={styles.gameArea}>
                  {/* ✅ Coluna de imagens — ORDEM FIXA: A, E, I, O, U */}
        ...
        <View style={styles.finalizadoContainer}>
          ...
          <View style={styles.center}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("NorteHome", { faseConcluida: 1 })
              }
            >
              <Image
                source={require("../assets/Norte/certo.png")}
