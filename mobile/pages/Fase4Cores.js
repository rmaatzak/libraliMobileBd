...
// Importar os vídeos das cores
const videosCores = {
  vermelho: require("../assets/videos/vermelho.mp4"),
  azul: require("../assets/videos/azul.mp4"),
  amarelo: require("../assets/videos/letra_a.mp4"),
};

// Dados da fase 4 - Cores Básicas
const fase4Data = {
  id: 4,
  titulo: "Cores Básicas",
  descricao: "Aprenda as cores básicas em LIBRAS",
  etapas: [
    // DEMONSTRAÇÕES
    {
      id: "demo_vermelho",
      tipo: "demonstracao",
      titulo: "Vermelho",
      descricao: "Sinal da cor VERMELHO em LIBRAS",
      video: videosCores.vermelho,
      cor: "Vermelho",
      videoDescricao: "Demonstração do sinal da cor VERMELHO",
    },
    {
      id: "demo_azul",
      tipo: "demonstracao",
      titulo: "Azul",
      descricao: "Sinal da cor AZUL em LIBRAS",
      video: videosCores.azul,
      cor: "Azul",
      videoDescricao: "Demonstração do sinal da cor AZUL",
    },
    {
      id: "demo_amarelo",
      tipo: "demonstracao",
      titulo: "Amarelo",
      descricao: "Sinal da cor AMARELO em LIBRAS",
      video: videosCores.amarelo,
      cor: "Amarelo",
      videoDescricao: "Demonstração do sinal da cor AMARELO",
    },
    // DESAFIOS (3 desafios apenas)
    {
      ...
      tipo: "desafio",
      titulo: "Desafio 1",
      descricao: "Qual cor está sendo sinalizada?",
      video: videosCores.vermelho,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 1,
      enunciado: "Selecione o vídeo que mostra a cor VERMELHO",
    },
    {
      id: "desafio_2",
      tipo: "desafio",
      titulo: "Desafio 2",
      descricao: "Identifique a cor sinalizada",
      video: videosCores.azul,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 2,
      enunciado: "Selecione o vídeo que mostra a cor AZUL",
    },
    {
      id: "desafio_3",
      tipo: "desafio",
      titulo: "Desafio 3",
      descricao: "Qual cor está sendo mostrada?",
      video: videosCores.amarelo,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 1,
      enunciado: "Selecione o vídeo que mostra a cor AMARELO",
    },
  ],
};

export default function Fase4Cores({ route, navigation }) {
  ...
  const etapa = fase4Data.etapas[etapaAtual];
  const totalDesafios = fase4Data.etapas.filter(
    (e) => e.tipo === "desafio"
  ).length;
  ...
  // Função para desbloquear a próxima fase (Fase 5)
  const desbloquearProximaFase = async () => {
    try {
      ...
      let fasesDesbloqueadas = progressoAtual
        ...
        : [1, 2, 3, 4]; // Fase 4 já está desbloqueada

      // Se fase 5 ainda não está desbloqueada, adiciona
      if (!fasesDesbloqueadas.includes(5)) {
        fasesDesbloqueadas.push(5);
  ...
  const handleResposta = (opcaoId) => {
    ...
    const isUltimoDesafio = etapaAtual === fase4Data.etapas.length - 1;
        ...
        [
          {
            ...
            onPress: () => {
              ...
              const primeiroDesafioIndex = fase4Data.etapas.findIndex(
                (e) => e.tipo === "desafio"
              );
  ...
  const avancarEtapa = () => {
    if (etapaAtual < fase4Data.etapas.length - 1) {
  ...
  const voltarEtapa = () => {
    if (etapaAtual > 0) {
      ...
      const etapaAnteriorId = fase4Data.etapas[etapaAtual - 1].id;
      setRespostas((prev) => {
      ...
      const etapaAnterior = fase4Data.etapas[etapaAtual - 1];
      if (
        ...
        >
          {BOTAO_PROXIMO_IMG ? (
            ...
            <Text style={styles.botaoNavegacaoPrimarioTexto}>
              {etapaAtual === fase4Data.etapas.length - 1
                ? "Concluir"
                : "Próximo"}
            </Text>
          )}
      ...
      <View style={styles.etapaContainer}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Text style={styles.enunciadoDesafio}>
            {etapa.enunciado || "Qual cor está sendo sinalizada no vídeo?"}
          </Text>
        </View>
        ...
        <View style={styles.progressoContainer}>
          ...
          <Text style={styles.instrucaoProgresso}>
            {acertos >= 2
              ...
              : `Precisa de ${2 - acertos} acerto(s) para desbloquear a Fase 5`}
          </Text>
        </View>
      </View>
    );
