...
// Importar os vídeos dos números
const videosNumeros = {
...
// Dados da fase 2 - Números
const fase2Data = {
  id: 2,
  titulo: "Números",
  descricao: "Aprenda os números de 1 a 4 em LIBRAS",
  etapas: [
    // DEMONSTRAÇÕES
    {
      id: "demo_1",
      tipo: "demonstracao",
      titulo: "Número 1",
      descricao: "Sinal do número 1 em LIBRAS",
      video: videosNumeros.numero1,
      numero: "1",
      videoDescricao: "Demonstração do sinal do número 1",
    },
    {
      id: "demo_2",
      tipo: "demonstracao",
      titulo: "Número 2",
      descricao: "Sinal do número 2 em LIBRAS",
      video: videosNumeros.numero2,
      numero: "2",
      videoDescricao: "Demonstração do sinal do número 2",
    },
    {
      id: "demo_3",
      tipo: "demonstracao",
      titulo: "Número 3",
      descricao: "Sinal do número 3 em LIBRAS",
      video: videosNumeros.numero3,
      numero: "3",
      videoDescricao: "Demonstração do sinal do número 3",
    },
    {
      id: "demo_4",
      tipo: "demonstracao",
      titulo: "Número 4",
      descricao: "Sinal do número 4 em LIBRAS",
      video: videosNumeros.numero4,
      numero: "4",
      videoDescricao: "Demonstração do sinal do número 4",
    },
    // DESAFIOS
    {
      id: "desafio_1",
      ...
      respostaCorreta: 1,
      enunciado: "Selecione o vídeo que mostra o número UM",
    },
    {
      id: "desafio_2",
      tipo: "desafio",
      titulo: "Desafio 2",
      descricao: "Qual número está sendo sinalizado?",
      video: videosNumeros.numero2,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 2,
      enunciado: "Selecione o vídeo que mostra o número DOIS",
    },
    {
      id: "desafio_3",
      tipo: "desafio",
      titulo: "Desafio 3",
      descricao: "Identifique o número",
      video: videosNumeros.numero3,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 1,
      enunciado: "Selecione o vídeo que mostra o número TRÊS",
    },
    {
      id: "desafio_4",
      tipo: "desafio",
      titulo: "Desafio 4",
      descricao: "Qual número está sendo mostrado?",
      video: videosNumeros.numero4,
      opcoes: [
        {
          id: 1,
      ...
      respostaCorreta: 2,
      enunciado: "Selecione o vídeo que mostra o número QUATRO",
    },
  ],
};

export default function Fase2Numeros({ route, navigation }) {
  ...
  const etapa = fase2Data.etapas[etapaAtual];
  const totalDesafios = fase2Data.etapas.filter(
    (e) => e.tipo === "desafio"
  ).length;
  ...
  const desbloquearProximaFase = async () => {
    try {
      ...
      // Se fase 3 ainda não está desbloqueada, adiciona
      if (!fasesDesbloqueadas.includes(3)) {
        fasesDesbloqueadas.push(3);
  ...
  const handleResposta = (opcaoId) => {
    ...
    const isUltimoDesafio = etapaAtual === fase2Data.etapas.length - 1;
        ...
        [
          {
            ...
            onPress: () => {
              ...
              const primeiroDesafioIndex = fase2Data.etapas.findIndex(
                (e) => e.tipo === "desafio"
              );
  ...
  const avancarEtapa = () => {
    if (etapaAtual < fase2Data.etapas.length - 1) {
  ...
  const voltarEtapa = () => {
    if (etapaAtual > 0) {
      ...
      const etapaAnteriorId = fase2Data.etapas[etapaAtual - 1].id;
      setRespostas((prev) => {
      ...
      const etapaAnterior = fase2Data.etapas[etapaAtual - 1];
      if (
        ...
        >
          {BOTAO_PROXIMO_IMG ? (
            ...
            <Text style={styles.botaoNavegacaoPrimarioTexto}>
              {etapaAtual === fase2Data.etapas.length - 1
                ? "Concluir"
                : "Próximo"}
            </Text>
          )}
      ...
      <View style={styles.etapaContainer}>
        ...
        <View style={styles.videoContainer}>
          ...
          <Text style={styles.enunciadoDesafio}>
            {etapa.enunciado || "Qual número está sendo sinalizado no vídeo?"}
          </Text>
        </View>
            ...
            {etapa.opcoes.map((opcao, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Texto da opção */}
                  <Text style={styles.opcaoVideoTexto}>
                    Opção {opcao.texto}
                  </Text>
        ...
        <View style={styles.progressoContainer}>
          ...
          <Text style={styles.instrucaoProgresso}>
            {acertos >= 3
              ...
              : `Precisa de ${3 - acertos} acerto(s) para desbloquear a Fase 3`}
          </Text>
        </View>
      </View>
    );
