...
const letters = [
  { id: "mae", label: "MÃE", videoId: "h", image: require("../assets/Sul/mae.png") },
  { id: "pai", label: "PAI", videoId: "j", image: require("../assets/Sul/pai.png") },
  { id: "irmao", label: "IRMÃO", videoId: "k", image: require("../assets/Sul/irmao.png") },
  { id: "vovo", label: "AVÓ", videoId: "l", image: require("../assets/Sul/vovo.png") },
  { id: "avo", label: "AVÔ", videoId: "m", image: require("../assets/Sul/avo.png") },
];

const VIDEOS_LIBRAS = {
  h: require("../assets/Sul/mae.mp4"),
  j: require("../assets/Sul/pai.mp4"),
  k: require("../assets/Sul/irmao.mp4"),
  l: require("../assets/Sul/vovo.mp4"),
  m: require("../assets/Sul/avo.mp4"),
};

export default function Minas({ navigation }) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {screen === "overlay" && (
        <Animated.View style={[styles.overlay, { opacity: overlayFade }]}>
          <Text style={styles.overlayText}>MINAS GERAIS</Text>
        </Animated.View>
      )}

      {/* TELA COMO SE DIZ */}
      {screen === "como" && !gameStarted && (
        <ImageBackground source={require("../assets/Sul/minas.png")} style={styles.bg}>
          <View style={styles.frameBorder}>
            <View style={styles.center}>
              ...
              <Image source={require("../assets/Sul/personagem.png")} style={styles.character} />
            </View>
          </View>
        </ImageBackground>
      )}
      ...
      {screen === "jogo" && gameStarted && gameOrder.length > 0 && (
        <Animated.View style={[styles.bg, { opacity: fadeAnim }]}>
          <ImageBackground source={require("../assets/Sul/minas.png")} style={StyleSheet.absoluteFill}>
            <View style={styles.frameBorder}>
              <View style={styles.center}>
      ...
      {screen === "finalizado" && (
        <View style={styles.finalizadoContainer}>
          ...
          <View style={styles.center}>
            ...
            <Animated.Image source={require("../assets/Sul/Sudeste4.png")} style={[styles.polaroid, { opacity: fadeAnim }]} />
            ...
            <View style={styles.finalButtonsRow}>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate("SulHome", { faseConcluida: 1 })}
              >
                <Image
                  source={require("../assets/Sul/certo.png")}
                  style={styles.iconButton}
