...
const letters = [
  { id: "mae", label: "CÃO", videoId: "h", image: require("../assets/Sul/cao.png") },
  { id: "pai", label: "GATO", videoId: "j", image: require("../assets/Sul/gato.png") },
  { id: "irmao", label: "PEIXE", videoId: "k", image: require("../assets/Sul/peixe.png") },
  { id: "vovo", label: "PÁSSARO", videoId: "l", image: require("../assets/Sul/passaro.png") },
  { id: "avo", label: "COELHO", videoId: "m", image: require("../assets/Sul/coelho.png") },
];

const VIDEOS_LIBRAS = {
  h: require("../assets/Sul/cao.mp4"),
  j: require("../assets/Sul/gato.mp4"),
  k: require("../assets/Sul/peixe.mp4"),
  l: require("../assets/Sul/passaro.mp4"),
  m: require("../assets/Sul/coelho.mp4"),
};

export default function RioJaneiro({ navigation }) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {screen === "overlay" && (
        <Animated.View style={[styles.overlay, { opacity: overlayFade }]}>
          <Text style={styles.overlayText}>RIO DE JANEIRO</Text>
        </Animated.View>
      )}

      {/* TELA COMO SE DIZ */}
      {screen === "como" && !gameStarted && (
        <ImageBackground source={require("../assets/Sul/rj.png")} style={styles.bg}>
          <View style={styles.frameBorder}>
            <View style={styles.center}>
              ...
              <Image source={require("../assets/Sul/roxorj.png")} style={styles.character} />
            </View>
          </View>
        </ImageBackground>
      )}
      ...
      {screen === "jogo" && gameStarted && gameOrder.length > 0 && (
        <Animated.View style={[styles.bg, { opacity: fadeAnim }]}>
          <ImageBackground source={require("../assets/Sul/rj.png")} style={StyleSheet.absoluteFill}>
            <View style={styles.frameBorder}>
              <View style={styles.center}>
      ...
      {screen === "finalizado" && (
        <View style={styles.finalizadoContainer}>
          ...
          <View style={styles.center}>
            ...
            <Animated.Image source={require("../assets/Sul/Sudeste3.png")} style={[styles.polaroid, { opacity: fadeAnim }]} />
            ...
            <View style={styles.finalButtonsRow}>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate("SulHome", { faseConcluida: 3 })}
              >
                <Image
                  source={require("../assets/Sul/certo.png")}
                  style={styles.iconButton}
